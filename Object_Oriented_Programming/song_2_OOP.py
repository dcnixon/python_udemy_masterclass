...
class Album:
    ...
    def add_song(self, song, position=None):
        ...
        :param song: (Song): The title of a song to add.
...
class Artist:
    ...
    def add_song(self, name, year, title):
        ...
        This method will add the song to an albumin the collection.
...
def find_object(field, object_list):
    """Check the 'object_list' to see if an object with a 'name' attribute
